...
public class TransactionReportView
{
    ...
    {
        status​List = new HashMap<String, String>();
        ...
        operation​List = new HashMap<String, String>();
        ...
        paymentMethod​List = new HashMap<String, String>();
        ...
        errorCode​List = new HashMap<String, String>();
        ...
        filterField​List = new HashMap<String, String>();
